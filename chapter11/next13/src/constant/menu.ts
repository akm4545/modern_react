...
export const demos: Array<{ name: string; items: Item[] }> = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                description: '그릅 레이아웃 - 주소에 영향을 미치지 않고 특정 주소에 따라 그룹화',
            },
        ],
    },
    {
        ...
        items: [
            {
                name: 'loading.js',
                slug: 'loading',
                description: '데이터를 불러오거나 렌더링하는 동안 표시할 수 있는 로딩 컴포넌트',
            },
            {
                name: 'error.js',
                slug: 'error',
        ...
        items: [
            {
                name: 'Client context',
                slug: 'context',
                description: '`Context`는 상태를 가지고 있으므로 반드시 클라이언트 컴포넌트여야 한다'
            },
        ],
    },
    {
